...
public class ArtsmiaController {
    ...
    void handleCreaGrafo(ActionEvent event) {
    	...
    	this.txtResult.setText(model.trovaMaggiorNumeroOpere()+"\n");
    	this.txtResult.appendText(model.isConnected());
    }

    @FXML
    void handleSimula(ActionEvent event) {
    	this.txtResult.clear();
    	if(this.txtFieldStudenti.getText().matches("^[0-9]$")){
    	this.txtResult.setText(model.simula(this.boxAnno.getValue(),Integer.parseInt(this.txtFieldStudenti.getText())));
    		
    		
    	}
    	else this.txtFieldStudenti.setText("inserirenumero" );
    }
    ...
    public void setModel(Model model) {
		...
		this.boxAnno.getItems().addAll(this.model.listAnni()) ;
